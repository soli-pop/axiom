...
[data-theme="light"]{
  ...
  --text:#1A2030;--muted:#4A5568;--dim:#718096;
  --mint:#1A6B5E;--mint2:rgba(26,107,94,0.45);--mint3:rgba(26,107,94,0.1);
  --neo:-3px -3px 8px rgba(255,255,255,0.92),3px 3px 8px rgba(0,0,0,0.13);
  --neo-sm:-2px -2px 5px rgba(255,255,255,0.88),2px 2px 5px rgba(0,0,0,0.1);
  --neo-in:inset -2px -2px 5px rgba(255,255,255,0.78),inset 2px 2px 5px rgba(0,0,0,0.08)
}
...
[data-theme="light"] .neo-input{background:var(--surf);color:var(--text)}
[data-theme="light"] .neo-input::placeholder{color:#9AA3B0}
[data-theme="light"] .dt th{border-bottom-color:rgba(0,0,0,0.1);color:var(--muted)}
[data-theme="light"] .dt td{border-bottom-color:rgba(0,0,0,0.05)}
[data-theme="light"] .dt tbody tr:hover td{background:rgba(26,107,94,0.05)}
[data-theme="light"] .si-item.active{color:var(--mint);background:rgba(26,107,94,0.1);border-color:rgba(26,107,94,0.2)}
  ...
  return (
    <div>
      <div className="neo fu" style={{padding:"16px 20px",marginBottom:16,borderLeft:"3px solid var(--acc)",display:"flex",alignItems:"center",gap:12}}>
        ...
        <div>
          <div style={{fontFamily:"var(--ff)",fontSize:16,fontWeight:600}}>Good day, Rector Reyes.</div>
  ...
  return (
    <div>
      <div className="neo fu" style={{padding:"16px 20px",marginBottom:16,borderLeft:"3px solid var(--acc)"}}>
        <div style={{fontFamily:"var(--ff)",fontSize:16,fontWeight:600}}>Good day, Prof. Luna.</div>
...
const StudentOverview = ({loading}) => {
  ...
  return (
    <div>
      <div className="neo fu" style={{padding:"16px 20px",marginBottom:16,borderLeft:"3px solid var(--acc)"}}>
        <div style={{fontFamily:"var(--ff)",fontSize:16,fontWeight:600}}>Good day, Alexa.</div>
